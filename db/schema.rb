...
ActiveRecord::Schema.define(version: 20160824231222) do
  ...
  add_index "spree_dientes", ["zona_id"], name: "index_spree_dientes_on_zona_id", using: :btree
  ...
  add_index "spree_materials", ["trabajo_id"], name: "index_spree_materials_on_trabajo_id", using: :btree
  ...
  create_table "spree_pedidos", force: :cascade do |t|
    t.text     "observacion"
    t.integer  "trabajo_id"
  ...
  create_table "spree_trabajos", force: :cascade do |t|
    t.string   "nombre"
    t.datetime "created_at",  null: false
    t.datetime "updated_at",  null: false
    t.integer  "category_id"
  ...
  add_index "spree_trabajos", ["category_id"], name: "index_spree_trabajos_on_category_id", using: :btree
  ...
  create_table "spree_transactions", force: :cascade do |t|
    t.string   "token"
    t.string   "payerid"
    t.integer  "user_id"
  ...
  add_index "spree_transactions", ["user_id"], name: "index_spree_transactions_on_user_id", using: :btree
  ...
  create_table "spree_zonas", force: :cascade do |t|
    t.string   "nombre"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end
