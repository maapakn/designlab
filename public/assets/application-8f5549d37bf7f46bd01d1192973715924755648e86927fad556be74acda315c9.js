...
(function() {
  jQuery(function() {
    ...
    return $('#pedido_trabajo_id').change(function() {
      var escaped_trabajo, options, trabajo;
      ...
      if (options) {
        ...
        return $('#pedido_material_id').parent().show();
      } else {
        $('#pedido_material_id').empty();
        return $('#pedido_material_id').parent().hide();
      }
    });
  });
